...
export const getSysArticle = () => (dispatch, getState) => {
  return dispatch({type: API_GET_SYS_ARTICLE, payload: request.get(API_GET_SYS_ARTICLE)})
}
...
export const putUserArticleStar = () => (dispatch, getState) => {
  return dispatch({
    type: API_PUT_USER_ARTICLE_STAR,
    payload: request.get(API_PUT_USER_ARTICLE_STAR, {
      header: {
        Authorization: getState().userReducer.token
      }
    })
...
export const putUserArticleUnStar = () => (dispatch, getState) => {
  return dispatch({
    type: API_PUT_USER_ARTICLE_UNSTAR,
    payload: request.get(API_PUT_USER_ARTICLE_UNSTAR, {
      header: {
        Authorization: getState().userReducer.token
      }
    })
